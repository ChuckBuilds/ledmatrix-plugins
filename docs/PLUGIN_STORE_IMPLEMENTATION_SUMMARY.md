...
curl http://localhost:5000/api/plugins/store/list
curl http://localhost:5000/api/plugins/store/search?q=clock
...
curl -X POST http://localhost:5000/api/plugins/install-from-url \
  -H "Content-Type: application/json" \
