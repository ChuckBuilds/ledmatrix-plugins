...
manager held in a `_managers` dict, favorites in favorite_teams, and identifiers in `home_abbr`/`away_abbr`. An earlier version
...
Run: <core-venv>/bin/python plugins/afl-scoreboard/test_vegas_priority_weight.py
"""
...
PLUGIN_CLASS = m.AflScoreboardPlugin
