...
The block now drives every display mode. What this pins down:
  ...
  * switch_show_date/switch_show_time (default true) hide a line on this
    display; the scroll-card show_date/show_time must not blank it.
  * vs_text, time_format and swap_date_time are shared
...
Run: <core-venv>/bin/python plugins/afl-scoreboard/test_switch_upcoming_center.py
"""
