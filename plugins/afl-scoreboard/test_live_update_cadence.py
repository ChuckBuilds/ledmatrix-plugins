...
Run: <core-venv>/bin/python plugins/afl-scoreboard/test_live_update_cadence.py
"""
...
try:
    from manager import AflScoreboardPlugin as Plugin  # noqa: E402
...
class _Stub:
    ...
    def __init__(self, leagues, enabled=True, shape="getter"):
