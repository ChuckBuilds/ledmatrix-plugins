"""
Simplified DynamicTeamResolver for afl plugin use
"""
...
class DynamicTeamResolver:
    ...
    def resolve_teams(self, team_list: List[str], sport: str = 'afl') -> List[str]:
        """
        Resolve a list of team names, expanding dynamic team names.
        
        Args:
            team_list: List of team names
            sport: Sport type for context (default: 'afl')
        ...
        for team in team_list:
            # For afl, we just pass through team names as-is
            # No dynamic patterns like AP_TOP_25 for afl
