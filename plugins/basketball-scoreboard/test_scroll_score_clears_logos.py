...
Run: <core-venv>/bin/python plugins/basketball-scoreboard/test_scroll_score_clears_logos.py
"""
...
FLAT_CARD = True          # True: card is sized from the height. False: panel-width card.
