...
Run: <core-venv>/bin/python plugins/baseball-scoreboard/test_non_favorite_live_duration.py
"""
...
fav_game = game("NYY", "BOS")       # favorite is home
fav_game_away = game("BOS", "NYY")  # favorite is away
non_fav_game = game("CHC", "STL")   # no favorite

# --- feature off (default 0) -> every live game uses the base duration -------
live = make_live(favorite_teams=["NYY"], game_display_duration=30,
                 non_favorite_live_game_duration=0)
