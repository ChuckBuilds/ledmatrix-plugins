#!/usr/bin/env python3
"""
Tests for baseball_timezone.resolve_timezone_name -- the resolution order that
...
Run: <core-venv>/bin/python plugins/baseball-scoreboard/test_timezone_resolution.py
"""
...
import baseball_timezone  # noqa: E402
from baseball_timezone import resolve_timezone, resolve_timezone_name  # noqa: E402
...
_real_system_timezone_name = baseball_timezone.system_timezone_name
...
def test_utc_last_resort():
    baseball_timezone.system_timezone_name = lambda: None
    try:
