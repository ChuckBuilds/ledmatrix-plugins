...
- Measured against the previous release: 64x32, 128x32 and 256x32 are byte-identical; every taller panel gains a larger score and logos the score is no longer drawn across.
