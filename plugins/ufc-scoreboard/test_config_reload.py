...
Run: LEDMATRIX_CORE=<core> <core-venv>/bin/python plugins/ufc-scoreboard/test_config_reload.py
"""
...
from manager import UFCScoreboardPlugin as Plugin  # noqa: E402
...
def build(cfg):
    return Plugin("ufc-scoreboard", copy.deepcopy(cfg), MockDisplayManager(128, 32),
