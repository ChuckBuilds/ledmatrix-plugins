...
manager, favorites in favorite_fighters, and identifiers in `fighter1_name`/`fighter2_name`. An earlier version
...
Run: <core-venv>/bin/python plugins/ufc-scoreboard/test_vegas_priority_weight.py
"""
...
PLUGIN_CLASS = m.UFCScoreboardPlugin
GAMES_ATTR = "live_games"
FAVS_ATTR = "favorite_fighters"
failures = []
...
def _game(**kw):
    ...
    return {"fighter1_name": kw.get("home", "Jon Jones"), "fighter2_name": kw.get("away", "Stipe Miocic")}
