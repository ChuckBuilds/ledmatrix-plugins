...
Run: LEDMATRIX_CORE=<core> <core-venv>/bin/python plugins/hockey-scoreboard/test_config_reload.py
"""
...
from manager import HockeyScoreboardPlugin as Plugin  # noqa: E402
...
def build(cfg):
    return Plugin("hockey-scoreboard", copy.deepcopy(cfg), MockDisplayManager(128, 32),
