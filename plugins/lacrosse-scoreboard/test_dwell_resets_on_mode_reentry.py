...
block was skipped instead of shown -- in football-scoreboard, measured live at one in five card
...
Run: <core-venv>/bin/python plugins/lacrosse-scoreboard/test_dwell_resets_on_mode_reentry.py
"""
