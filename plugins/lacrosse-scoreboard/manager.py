...
FAVORITE_CHECK_LEAGUES = {
    'ncaa_mens': ("NCAA Men's Lacrosse", 'lacrosse/mens-college-lacrosse'),
    'ncaa_womens': ("NCAA Women's Lacrosse", 'lacrosse/womens-college-lacrosse'),
}
...
class LacrosseScoreboardPlugin(BasePlugin if BasePlugin else object):
    ...
    def on_config_change(self, new_config: Dict[str, Any]) -> None:
        ...
        self.game_display_duration = float(defaults.get("game_display_duration", self.config.get("game_display_duration", 15)))
        ...
        self.logger.info(
            "Lacrosse config updated live - ncaa_mens:%s ncaa_womens:%s, modes=%s",
            self.ncaa_mens_enabled, self.ncaa_womens_enabled, self.modes,
        )
