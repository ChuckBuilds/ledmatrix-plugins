...
- Ported from the football/baseball lineage in the same PR, per `docs/plugin-development/08-shared-sports-code.md`. 128x32 is byte-identical to the previous release.
