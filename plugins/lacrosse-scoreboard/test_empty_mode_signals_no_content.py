...
-- for its entire display duration. Found alongside the same fault in hockey-scoreboard, which was reported for
NHL recent and live in August, when those are empty while upcoming is not.
...
Run: <core-venv>/bin/python plugins/lacrosse-scoreboard/test_empty_mode_signals_no_content.py
"""
...
class _Manager:
    ...
    def __init__(self, games, enabled=True):
        ...
        self.logger = _Logger()
        self.sport_key = 'ncaa_mens_lacrosse'
