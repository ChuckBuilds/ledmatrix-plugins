...
that the soccer end-of-game rules themselves are unchanged.

Run: <core-venv>/bin/python plugins/soccer-scoreboard/test_null_period_really_over.py
...
check("live game is not over", shared_is_over,
      {"period_text": "2H 67'", "period": 2, "clock": "67'"}, False)
...
check("period None", shared_is_over,
      {"period_text": "2H 67'", "period": None, "clock": "67'"}, False)
check("non-numeric period string", shared_is_over,
      {"period_text": "2H 67'", "period": "ET", "clock": "67'"}, False)
